|ID|Process/Tool|Topic|From|Potential Presenter|Status|Abstract|
|---|---|---|---|---|---|---|
|01|Tool|Fossology Training Beginner/Expert||Oliver F.||https://github.com/Open-Source-Compliance/Sharing-creates-value/blob/master/docs/Tooling-Landscape/OSS-Based-License-Compliance-Tools.md#fossology|
|02|Tool|Reuse.software Repository Linter||||https://github.com/Open-Source-Compliance/Sharing-creates-value/blob/master/docs/Tooling-Landscape/OSS-Based-License-Compliance-Tools.md#reuse|
...
|07|Tool|OpenChain Tooling Group - Capability Map - Status and next steps||||https://github.com/Open-Source-Compliance/Sharing-creates-value/blob/master/Tooling-Landscape/CapabilityMap/OC_ToolingChain_v1.6.0.pptx|
|08|Tool|OpenChain Tooling Group - List of available tools - Status and next steps||||https://oss-compliance-tooling.org/Tooling-Landscape/OSS-Based-License-Compliance-Tools/|
|09|Process/Tool|Establishing trusted and consistent open source management across the supply chain with the OpenChain ISO standards​||Shane C.||
