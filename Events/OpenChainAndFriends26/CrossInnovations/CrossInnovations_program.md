...
This Cross-Innovations topic stream is part of the OpenChain and Friends Event in Stuttgart 2026.   
...
In the second part, I will focus on the ROS 2 community and how it supports development through shared tools, common interfaces, and collaboration between companies and individuals. Concrete examples from small and medium-sized enterprises (SMEs) will illustrate how ROS 2 can shorten development time and avoid reinventing common building blocks. I will present real-world deployments of ROS 2 both in robotic cells and in mobile robotics, highlighting how it is used to integrate robots, sensors, and control systems in different industrial contexts. Finally, I’ll cover practical tools and workflows for automation, including simulation, automated testing, and reproducible deployment, showing how teams can move from prototype to production in a controlled and efficient way using ROS 2.
  
*Yasmine Makkaoui (Fraunhofer)*  
  
### Bio  
Yasmine is a robotics research engineer at Fraunhofer IPA, working with ROS 2 in real-world applications ranging from robotic cells to mobile robots.
She is particularly interested in how open source enables collaboration in robotics: sharing common building blocks, improving tools together, and avoiding duplicated effort across teams. This approach is especially valuable in industrial contexts, where it helps reduce development costs, improve reliability, and speed up integration.
She is also involved in the ROS-Industrial Consortium, which bridges the gap between open source development and industrial requirements, helping make ROS 2 a viable option for production systems.
