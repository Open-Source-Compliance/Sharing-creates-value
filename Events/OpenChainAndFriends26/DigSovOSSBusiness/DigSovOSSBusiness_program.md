...
![Digital Sovereignty and Open Source in Business](digitalsovereigntyosbusiness.png)
- [Keynotes](#keynotes)
- [Agenda](#agenda)
- [Abstracts, Bios and more](#details)
- [Potential Follow-ups](#potential-follow-ups)

This Digital Sovereignty and Open Source Business topic stream is part of the OpenChain and Friends Event in Stuttgart 2026.   
...
<sub>[go to schedule](#Panelm)</sub>
<a name="T1.3-Moderator"></a>  
## Moderator
*Lothar Becker (OSBA)*
...
<sub>[go to schedule](#T1.3-4m)</sub>
...
https://matrix.to/#/#digitalsovereignty:matrix.org

For OpenChain webinars about Digital Sovereignty and Open Source in Business, please check our webinar library [Webinars](https://openchainproject.org/webinars)  
