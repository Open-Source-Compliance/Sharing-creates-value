...
- TUESDAY 14:00-15:35 **T1.1-Moderator** [Janneke van de Westelaken (Bosch)](#Janneke-van-de-Westelaken-bosch)<a name="T1.1-Moderator">  
- TUESDAY 14:00-14:20 **T1.1-1** [Inventor's Handbook - Guide to the product development process using open source software](#Inventor's-Handbook-Guide-to-the-product-development-process-using-open-source-software)<a name="T1.1-1">  
- TUESDAY 14:25-14:45 **T1.1-2** [OpenChain Education Materials and Working Group](#OpenChain-Education-Materials-and-Working-Group)<a name="T1.1-2">  
- TUESDAY 14:50-15:10 **T1.1-3** [Bosch's educational curriculum on Open Source and InnerSource](#Bosch's-educational-curriculum-on-Open-Source-and-InnerSource)<a name="T1.1-3">  
- TUESDAY 15:15-15:35 **T1.1-4** [Digital Independence Day](#Digital-Independence-Day)<a name="T1.1-4">
- THURSDAY 09:00-TBD **T3.4-Moderator** [Martin Yagi(First Light Fusion)](#Martin-Yagi-FirstLightFusion)<a name="T3.4-Moderator"> 
- THURSDAY 09:00-09:30 **T3.4-1** [Intro to the track and agenda](#intro-to-the-track-and-agenda)<a name="T3.4-1">  
- THURSDAY 09:30-10:30 **T3.4-2** [Topic 1: Automate your OSPO via Open Source Collaboration](#topic-1-Automate-your-OSPO-via-Open-Source-Collaboration)<a name="T3.4-2">  
- THURSDAY 10:30-11:30 **T3.4-3** [Topic 2: Stream Introduction and FOSS license scanning: The why, the how and the community approach](#topic-2-Stream-Introduction-and-FOSS-license-scanning)<a name="T3.4-3">  
- THURSDAY 11:45-12:45 **T3.4-4** [Topic 3: Surviving the "AI Slopageddon": How AI shakes the foundations of Open Source](#topic-3-Surviving-the-AI-Slopageddon)<a name="T3.4-4">  
- THURSDAY 13:45-14:15 **T3.4-5** [Topic 4: OpenChain Education Tooling Training creation](#topic-4-OpenChain-Education-Tooling-Training-creation)<a name="T3.4-5">  

# Details

## Moderator Day 1: Janneke van de Westelaken (Bosch)

<sub>[go to schedule](#T1.1-Moderator)</sub>"
...
<sub>[go to schedule](#T1.1-3)</sub>
## Digital Independence Day 

### Abstract:  
The Digital Independence Day is a "relaxed rebellion": on the first Sunday of every month, a broad coalition of organisations calls for #DigitalIndependenceDay (DID). We are switching to democracy-friendly digital alternatives, reclaiming our free digital lives and putting an end to the destruction of democracy. And we are gradually securing our digital independence.


*/madonius (Chaos Computer Club Karlsruhe (Entropia))*

### Bio 
madonius is a security expert by day and a hacker at Chaos Computer Club Karlsruhe (Entropia) in his spare time. He represents the Entropia on various occasions in political and non-political settings. He is interested in exploring the limitations of technology, in policy and how both impact daily life and society.
...
<sub>[go to schedule](#T1.1-4)</sub>


## Moderator Day 3: Martin Yagi (First Light Fusion)

<sub>[go to schedule](#T3.4-Moderator)</sub>"

## Intro to the track and agenda

### Abstract:
Welcome and introduction of the topic stream and agenda of Day 3

*Martin Yagi (First Light Fusion)*

<sub>[go to schedule](#T3.4-1)</sub>
## Topic 1: Topic 1: Automate your OSPO via Open Source Collaboration 
...
<sub>[go to schedule](#T3.4-3)</sub>
## Topic 3: Surviving the "AI Slopageddon": How AI shakes the foundations of Open Source
...
### Bio 
Raphaël Semeteys, Head of Tech Advocacy at Worldline. https://raphiki.github.io
...
<sub>[go to schedule](#T3.4-4)</sub>
## Topic 4: OpenChain Education Tooling Training creation 
...
<sub>[go to schedule](#T3.4-5)</sub>

## We can support further talks, presentations, workshops. Please contact us to discuss.
